          ...
          >
            ...
            <div className="contact-details">
              ...
              <div className="contact-social">
                <a href="https://linkedin.com/company/sommo" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="LinkedIn" data-cursor="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="none">
                ...
                <a href="https://dribbble.com/sommo" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Dribbble" data-cursor="Dribbble">
                  <svg viewBox="0 0 24 24" fill="none">
                ...
                <a href="https://youtube.com/@sommo" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="YouTube" data-cursor="YouTube">
                  <svg viewBox="0 0 24 24" fill="none">
